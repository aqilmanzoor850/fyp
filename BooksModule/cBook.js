...
class cBook extends Component {
    ...
    downloadcBook = async () => {
            var fireref = firebase.storage().ref().child('cbooks/CNotesForProfessionals.pdf');
    ...
    downloadccBook = async () => {
        var fireref = firebase.storage().ref().child('cbooks/Cpp123uo00es0162.pdf');
        var url = await fireref.getDownloadURL()
        console.log(url)
        this.setState({download: url}, ()=> {
            Linking.openURL(this.state.download)
                       ...
                       C Books
                            ...
                            <View style={{display:'flex', flexDirection:'row',marginTop:'10%'}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.opencBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/cc.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openccBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/ccc.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            ...
                            <View style={{display: "flex", flexDirection:'row',}}>
                                <View style={{ width: '50%', marginTop: 20, marginRight: 10,width:'30%',marginLeft:'10%'}} >
                                    <Button 
                                        title='View'
                                        onPress={() => this.openccBook()}
                                    />
                                </View>
                                <View style={{ width: '50%', marginTop: 20,width:'30%',marginLeft:'10%'}} >
                                    <Button 
                                        title='Download'
                                        onPress={() => this.downloadccBook()}
                                    />
                                </View>
                            </View>
                        </View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.opencBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/cccc.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.opencBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/cb.png')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.opencBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/cbb.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
