...
class androidBook extends Component {
    state = { java:'', url:'', loading: false, download:'', showWebView: true }

    downloadandroidBook = async () => {
            var fireref = firebase.storage().ref().child('androidbooks/AndroidNotesForProfessionals.pdf');
        ...
        if(this.state.loading===false){
            return ( 
                <View style={{ paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0}}>
                    ...
                    <Text style={{fontWeight:'900',marginLeft:'25%',marginTop:'-5%',fontSize:30,  height:screenHeight*.09,color:'black', fontStyle:'normal', marginBottom: 20}}>
                      Android Books
                    </Text>
                   </View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row',marginTop:'10%'}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openandroidBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/a1.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View>
                                    ...
                                    <Text key={item => item.toString()+6} style={{textAlign:'center', fontWeight:'600', color:'#eee', marginLeft:'2%',fontSize: 16, width: '50%'}}>
                                            Think Android (How to think like a Computer Scientist)
                                    </Text>
                            ...
                            <View style={{display: "flex", flexDirection:'row',}}>
                                <View style={{ width: '50%', marginTop: 20, marginRight: 10,width:'30%',marginLeft:'10%'}} >
                                    <Button 
                                        title='View'
                                        onPress={() => this.openandroidBook()}
                                    />
                                </View>
                                <View style={{ width: '50%', marginTop: 20,width:'30%',marginLeft:'10%'}} >
                                    <Button 
                                        title='Download'
                                        onPress={() => this.downloadandroidBook()}
                                    />
                                </View>
                            </View>
                        </View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openandroidBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/a2.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openandroidBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/a3.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openandroidBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/a4.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                                    ...
                                    An Introduction To Android System
                                    </Text>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openandroidBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/a5.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center',marginTop:'10%'}}>
                                    ...
                                    Fundamentals of Android operating
                                    </Text>
