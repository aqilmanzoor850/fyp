        ...
        if(this.state.loading===false){
            return ( 
                <View style={{ paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0}}>
                    ...
                    <Text style={{fontWeight:'900',marginLeft:'20%',marginTop:'-5%',fontSize:30,  height:screenHeight*.99,width:screenWidth*.9,color:'black', fontStyle:'normal', marginBottom: 20}}>
                       Operating System
                    </Text>
                   </View>
