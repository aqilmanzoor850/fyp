...
class JavaBook extends Component {
    ...
    downloadRBook = async () => {
            var fireref = firebase.storage().ref().child('Rbook/RNotesForProfessionals.pdf');
                            ...
                            <View style={{display:'flex', flexDirection:'row',marginTop:'10%'}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openRBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/rr1.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View>
                                    ...
                                    <Text key={item => item.toString()+6} style={{textAlign:'center', fontWeight:'600', color:'#eee', marginLeft:'2%',fontSize: 16, width: '50%'}}>
                                            R programming for Bioformatics
                                    </Text>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openRBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/rr2.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openRBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/rr3.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openRBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/rr4.jpg')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                               <View style={{alignItems:'center'}}>
                        ...
                        <View>
                            <View style={{display:'flex', flexDirection:'row', marginTop: 30}}>
                                <View style={{display:'flex', flexDirection:'row', marginBottom: 0, justifyContent:'center', alignItem:'center'}}>
                                    <View style={{width:screenWidth*.38, height:screenHeight*.28, overflow:'hidden'}}>
                                        <TouchableOpacity onPress={() => {this.openRBook()}}>
                                            <Image resizeMode={'cover'} style={{width: screenWidth*.37, height: screenHeight*.28, marginLeft: 10, marginBottom:0}} source={require( '../Images/rr5.png')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
